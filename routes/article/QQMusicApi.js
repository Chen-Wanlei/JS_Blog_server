...
//加密函数
let __sign_hash_20200305 = function (n) {
    function l(n, t) {
...
module.exports = function (songmid) {
    let data = {
        "req_0": {
            ...
            "param": {
                ...
                "songmid": [songmid],
                "uin": "1693256432",
                "platform": "20" //不加默认fromtag=999平台，加上是fromtag=66平台
            },
        }
    }
    let url = 'https://u.y.qq.com/cgi-bin/musics.fcg?' + '-=getplaysongvkey7279213396502286' + '&loginUin=1693256432&sign=' + getSign(data) + '&format=json&data=' + encodeURIComponent(JSON.stringify(data));
    return axios({
        method: 'get',
        url: url,
    })
